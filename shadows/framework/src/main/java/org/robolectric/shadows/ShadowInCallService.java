...
public class ShadowInCallService extends ShadowService {
  ...
  /** @return whether {@code setMuted()} method has been called. */
  ...
  /** @return whether {@code setAudioRoute()} method has been called. */
  ...
  /** @return whether {@code requestBluetoothAudio()} method has been called. */
  @TargetApi(P)
